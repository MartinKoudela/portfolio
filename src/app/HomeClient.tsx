                    ...
                    >
                        <div>
                            ...
                            <p className="mt-8 max-w-xl text-xl text-zinc-400 leading-relaxed">
                                <span translate="no">Junior</span> <span
                                className="text-white">Full-stack Developer</span> focused on software
                    ...
                    <div className="max-w-3xl">
                        ...
                        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-12">
                            <p className="text-xl leading-relaxed text-zinc-400">
                                ...
                                working with modern frameworks and building <span
                                className="text-white">clean</span>, <span
                                className="text-white"> reliable</span> applications,
